def sjusgsbdndjsjhensksskksns________ksjehsjskososokHCXXGajjwjwjwjwejjejekekekwpw():
    import os
    ...
    f"""
    {O}╔═════════════════════════════════════════════════════════════════════════════╗
    {O}║{M} [+{M}] {P}TikTok  {M} : {P}tiktok.com/@4n0n1m1t6             {O} ║ {M} [+{M}]{P} WhatsApp {M} : {P}+6285728337030   {O}   ║
    {O}║{M} [+{M}] {P}Telegram{M} : {P}t.me/PloloKimz         {O}║{M}  [+{M}] {P}Instagram {M}: {P}pstar7.dev        {O}  ║
    {O}║ {M}[+{M}] {P}Github   {M}: {P}https://github.com/Hyezzcraxksz{O}  ║{M}  [+{M}] {P}YouTube   {M}:{P} @Mr-Pstar7      {O}    ║
    {O}╚═════════════════════════════════════════════════════════════════════════════╝
    {O}║                                    {M}Menu{O}                                     ║
    {O}╔═════════════════════════════════════════════════════════════════════════════╗
    ...
    {O}║{M}  [{P}11{M}] -> {P}Cpanel Checker             {O} ║ {M} [{P}31{M}] -> {P}Cpanel Bruteforce        {O}   ║
    {O}║{M}  [{P}12{M}] ->{P} Wp Login Checker            {O}║  {M}[{P}32{M}] -> {P}Nik Checker                {O} ║
    ...
    {O}║ {M} [{P}20{M}] -> {P}Cms Detector                {O}║ {M} [{P}40{M}] -> {P}Malware Generator          {O} ║
    {O}╚═════════════════════════════════════════════════════════════════════════════╝
        """)
    while True:
        choice = input(f"""{M}┌───({P}{username_pc}@Leonora{M})─[{P}~{M}] 
└──{P}$ {reset}""")
